...
//                         langid  name
        ...
        {
            var json = Resx.GetText("fuyu", $"database.locales.client.languages.json");
...
//                                 langid             key     value
        ...
        private void LoadGlobalLocales()
        {
            ...
            {
                var json = Resx.GetText("fuyu", $"database.locales.client.locale-{languageId}.json");
                var response = Json.Parse<ResponseBody<Dictionary<string, string>>>(json);
...
//                                 langid  locale
        ...
        private void LoadMenuLocales()
        {
            ...
            foreach (var languageId in languages.Keys)
            {
                var json = Resx.GetText("fuyu", $"database.locales.client.menu.locale-{languageId}.json");
