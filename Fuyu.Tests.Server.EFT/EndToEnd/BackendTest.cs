...
namespace Fuyu.Tests.Server.EFT.EndToEnd
{
    [TestClass]
    public class BackendTest
    {
        ...
        public static void AssemblyInitialize(TestContext testContext)
        {
            ...
            Fuyu.Server.Core.Services.AccountService.RegisterAccount("test-username", "test-password");
            var sessionId = Fuyu.Server.Core.Services.AccountService.LoginAccount("test-username", "test-password");
            Fuyu.Server.Core.Services.AccountService.RegisterGame(sessionId, EGame.EFT, "unheard");
