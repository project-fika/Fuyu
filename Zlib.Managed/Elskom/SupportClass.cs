...
namespace Elskom.Generic.Libs
{
    ...
    internal static class SupportClass
    {
        ...
        internal static int URShift(int number, int bits) => number >= 0 ? number >> bits : (number >> bits) + (2 << ~bits);
        ...
        /// <param name="bits">Ammount of bits to shift.</param>
        /// <returns>The resulting number from the shift operation.</returns>
        internal static long URShift(long number, int bits) => number >= 0 ? number >> bits : (number >> bits) + (2L << ~bits);
