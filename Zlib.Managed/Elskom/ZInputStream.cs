...
namespace Elskom.Generic.Libs
{
    ...
    internal class ZInputStream : Stream
    {
        ...
        internal ZInputStream(Stream input)
        {
        ...
        internal ZInputStream(Stream input, int level)
        {
            this.BaseStream = input;
            this.InitBlock();
        ...
        /// </summary>
        internal virtual int FlushMode { get; set; }

        /// <summary>
        /// Gets the total number of bytes input so far.
        /// </summary>
        internal virtual long TotalIn => this.Z.TotalIn;

        /// <summary>
        /// Gets the total number of bytes output so far.
        /// </summary>
        internal virtual long TotalOut => this.Z.TotalOut;

        /// <summary>
        /// Gets or sets a value indicating whether there is more input.
        /// </summary>
        internal bool Moreinput { get; set; }
        ...
        /// </summary>
        internal virtual void EndStream()
        {
            if (this.Compress)
            {
                this.Z.DeflateEnd();
