...
namespace Elskom.Generic.Libs
{
    ...
    internal class InflaterInputBuffer
    {
        ...
        internal InflaterInputBuffer(Stream stream)
            : this(stream, 4096)
        {
        }
        ...
        internal InflaterInputBuffer(Stream stream, int bufferSize)
        {
        ...
        /// </summary>
        internal int RawLength { get; private set; }

        /// <summary>
        /// Gets the contents of the raw data buffer.
        /// </summary>
        /// <remarks>This may contain encrypted data.</remarks>
        internal IEnumerable<byte> RawData { get; private set; }

        /// <summary>
        /// Gets the number of useable bytes in <see cref="ClearText"/>.
        /// </summary>
        internal int ClearTextLength { get; private set; }

        /// <summary>
        /// Gets the contents of the clear text buffer.
        /// </summary>
        internal IEnumerable<byte> ClearText { get; private set; }
        ...
        internal void SetInflaterInput(ZInputStream zinput)
        {
            if (zinput == null)
            {
        ...
        internal int ReadRawBuffer(byte[] buffer)
        ...
        /// <returns>Returns the number of bytes read.</returns>
        internal int ReadRawBuffer(byte[] outBuffer, int offset, int length)
        {
            if (length < 0)
            {
